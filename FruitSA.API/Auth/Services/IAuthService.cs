...
namespace FruitSA.API.Auth.Services
{
    ...
    public class UserService : IAuthService
    {
        ...
        public async Task<UserManagerResponse> RegisterUserAsync(RegisterViewModel model)
        {
            if (model == null)               
                ...
                {
                    Message = "The User Email, Password and ConfirmPassword is required",
                    IsSuccess = false,
                };
        ...
        public async Task<UserManagerResponse> LoginUserAsync(LoginViewModel model)
        {
            ...
            if (user == null)
            {
                return new UserManagerResponse
                {
                    Message = "Wrong Email/Password please try again.", //Wrong Email
                    IsSuccess = false,
                };
            }
            ...
            if (!result)
                return new UserManagerResponse
                {
                    Message = "Wrong Email/Password please try again.",//Wrong Password
                    IsSuccess = false,
                };
